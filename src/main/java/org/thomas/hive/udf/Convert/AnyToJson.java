package org.thomas.hive.udf.Convert;
...
/*
 ...
 使用:
    to_json( struct("name":"Bob","value",23.0,"color_list",array( "red", "yellow", "green" ),"inner_map", map( "a", 1, "b", 2, "c" 3) ) )

 输出:
    '{ "name":"Bob", "value":23.0,"color_list":[ "red", "yellow", "green" ],"inner_map":{ "a":1, "b":2, "c":3 } }'
 */
@Description(name = "to_json",
        value = "_FUNC_(struct, convert_to_camel_case) - Returns a JSON string from an arbitrary Hive structure."
)
public class AnyToJson extends GenericUDF {
    ...
    private class TimestampInspectorHandle implements InspectorHandle {
        ...
        public void generateJson(JsonGenerator gen, Object obj) throws JsonGenerationException, IOException {
            if (obj == null) {
                ...
                Timestamp timestamp = timestampInspector.getPrimitiveJavaObject(obj).toSqlTimestamp();
